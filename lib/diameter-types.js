...
var types = {
    ...
    'Unsigned64': {
        ...
        decode: function(buffer) {
            return new Long(buffer.readUInt32BE(4), buffer.readUInt32BE(0), true);
        }
    },
    'Integer64': {
        encode: function(value) {
            ...
            if (value instanceof Long) {
                ...
                buffer.writeInt32BE(value.getLowBits(), 4);
            } else {
        ...
        decode: function(buffer) {
            return new Long(buffer.readInt32BE(4), buffer.readInt32BE(0), false);
        }
    },
    'Time': {
        encode: function(value) {
    ...
    'IPAddress': {
        encode: function(value) {
            ...
            if (ip.kind() === 'ipv4') {
                ...
                return Buffer.concat([new Buffer(ip.toString().split('.'))]);
            } else {
